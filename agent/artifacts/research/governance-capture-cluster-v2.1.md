...
| **INDEPENDENT** | pairwise <70% with co-voted ≥3, both top-2 active | **2 ✓ PROMOTION THRESHOLD MET** (opcollective.eth HB#534 — 1st empirical case via vigil HB#518 heuristic + argus HB#535 validation, SUB-TIER-ROBUST cross-validated; **cryptomods.eth HB#604 — 2nd case via vigil HB#553 RANKED mode end-to-end validation, ratio 1.03×/1.22× + 50% pairwise on n=12 + top1Active=29/top2Active=31, SUB-TIER-ROBUST cross-method**). Per-variant promotion threshold n=2 MET |
