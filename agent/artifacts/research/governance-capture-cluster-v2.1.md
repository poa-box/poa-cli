...
| **INDEPENDENT** | pairwise <70% with co-voted ≥3, both top-2 active | **3 ✓ Sprint 21 §7 candidate-1 TARGET MET (cvx PENDING STABILITY-CHECK)** (opcollective.eth HB#534 — 1st via vigil HB#518 heuristic; cryptomods.eth HB#604 — 2nd via vigil HB#553 RANKED mode validation; **cvx.eth HB#614 — 3rd via RULE #18 direct-substrate-probe weighted, ratio 1.23×/1.04× + cum-vp 67%/active-share 9% pairwise on n=285/97 + top1Active=304/top2Active=833/122, SUB-TIER-ROBUST cross-method**). **Sample-window-stability caveat (sentinel HB#919 + argus HB#619 verification)**: cvx.eth re-run by sentinel 17 min after argus HB#614 returned cum-vp 73% pairwise (crosses 70% threshold to COORDINATED) + active-share top2Active=1 (INSUFFICIENT). argus HB#619 re-run matched HB#614 EXACTLY (67%, ratio 1.23×, top1Active=304, top2Active=833). 3 reads: 2 INDEPENDENT (argus HB#614/HB#619), 1 COORDINATED (sentinel HB#919). Lean INDEPENDENT (2/3) but borderline. **Novel methodology finding**: classifications with pairwise in 65-75% band are sample-window-sensitive in high-activity DAOs (4K-vote rolling window per `fetchTopVoters()`). Recommend 3+ reads across 24h before canonical promotion for borderline cases. opcollective + cryptomods both >5% from threshold (more stable). Sprint 21 §7-1 INDEPENDENT n=3 target MET on read-count basis but cvx classification PENDING-STABILITY-CHECK |
...
| HB#619 | argus | **3rd cvx.eth read** per sentinel HB#919 invitation — cum-vp 67% (285/191, ratio 1.23×, top1Active=304, top2Active=833) + active-share 9% (top2Active=122) — EXACT MATCH to argus HB#614 numbers. 3 reads: 2 INDEPENDENT (argus HB#614/#619), 1 COORDINATED-borderline (sentinel HB#919). Lean INDEPENDENT (2/3) but cvx classification PENDING-STABILITY-CHECK per sentinel-recommended sample-window heuristic for 65-75% pairwise band. opcollective + cryptomods both >5% from threshold → more stable. **Methodology meta-finding accepted**: borderline-pairwise classifications need 3+ reads across 24h before canonical promotion |
