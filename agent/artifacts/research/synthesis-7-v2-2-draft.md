...
- **INDEPENDENT (A-dual sub-variant, n=6 EMPIRICAL / 1 SUB-TIER-ROBUST + 3 SIGNATURE-ROBUST + 2 THRESHOLD-ADJACENT-BORDERLINE)**: per-HB#632 FULL ACCOUNTING:
  ...
  - **SIGNATURE-ROBUST-only (n=3)**: sdbal.eth (argus HB#562) + bskt.eth (argus HB#563) + **comp-vote.eth (argus HB#632/sentinel HB#926 T1 CROSS-AGENT-CONSISTENT confirmed — cum-vp ratio 1.03× + 50% pairwise on n=13 + top1Active=6 + top2Active=6 → INDEPENDENT; active-share INSUFFICIENT with saturation warning blocks SUB-TIER-ROBUST)**. Layered-governance-adjacent (compound has on-chain Governor primary; Snapshot signaling-only). Plain INDEPENDENT cum-vp + INSUFFICIENT-active-share shape — does NOT warrant new variant per RULE #19
