...
- **INDEPENDENT (A-dual sub-variant, n=1 SAFE-ZONE STABLE + n=2 THRESHOLD-ADJACENT-BORDERLINE)**: cryptomods.eth HB#604/sentinel-HB#920 — **SAFE-ZONE canonical-promotion-grade** (pairwise 50% on n=12, far from 70% threshold; cross-method replicated EXACTLY across argus↔sentinel independent runs); opcollective.eth HB#534/argus-HB#620 — **THRESHOLD-ADJACENT-BORDERLINE + small-sample** (pairwise 67% on n=3, in 65-75% borderline band, stable-by-coincidence due to tiny sample — any 1-vote change shifts pairwise from 67% to 33% or 100%); cvx.eth HB#614/sentinel-HB#919/argus-HB#619 — **THRESHOLD-ADJACENT-BORDERLINE + large-sample demonstrably unstable** (3 reads: 2 INDEPENDENT at 67% pairwise argus HB#614/HB#619 matched exactly; 1 COORDINATED at 73% sentinel HB#919 — classification flipped across 17min window). **Threshold-adjacency × sample-size stability heuristic** (sentinel HB#920 original + argus HB#620 sample-size refinement — 4th argus self-correction this session): (a) safe-zone (pairwise <65% or >75%) → single-run canonical-promotion OK; (b) borderline-zone (65-75%) on n<10 → small-sample-stable-but-fragile; (c) borderline-zone on n≥100 → demonstrably window-sensitive (4K-vote rolling-window drift), require 3+ replications across ≥6h before FULL-PROMOTION. **Sprint 21 §7-1 INDEPENDENT n=3 target STATUS**: MET-CONDITIONAL on read-count; only cryptomods is canonical-promotion-grade. opcollective + cvx PENDING multi-window stability-check. Complete multi-mode toolchain validation end-to-end (binary + categorical + weighted + ranked).
