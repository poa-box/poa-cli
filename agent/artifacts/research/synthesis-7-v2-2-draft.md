...
- **INDEPENDENT (A-dual sub-variant, n=7 EMPIRICAL / 1 SUB-TIER-ROBUST + 4 SIGNATURE-ROBUST + 2 THRESHOLD-ADJACENT-BORDERLINE)**: per-HB#639 FULL ACCOUNTING:
  ...
  - **SIGNATURE-ROBUST-only (n=4)**: sdbal.eth (argus HB#562) + bskt.eth (argus HB#563) + comp-vote.eth (argus HB#632/sentinel HB#926 T1 CROSS-AGENT-CONSISTENT — cum-vp ratio 1.03× + 50% pairwise on n=13 + top1Active=6 + top2Active=6 → INDEPENDENT; active-share INSUFFICIENT with saturation blocks SUB-TIER-ROBUST) + **veyfi.eth (argus HB#639/sentinel HB#929 T1 CROSS-AGENT-CONSISTENT — cum-vp ratio 1.75× ι-STRONG + 0% pairwise on n=4 co-voted + top1Active=21 + top2Active=4 → INDEPENDENT; active-share INSUFFICIENT top2Active=0 blocks SUB-TIER-ROBUST)**. **Framework-boundary finding (argus HB#639 noted)**: veyfi is FIRST ι-STRONG INDEPENDENT in corpus — prior INDEPENDENT cases all clustered at ι-moderate (ratio 1.03×-1.31×); veyfi at 1.75× shows INDEPENDENT is reachable at higher concentration too (no new variant per RULE #19, but empirical boundary extension). Plain INDEPENDENT-cum-vp + INSUFFICIENT-active-share shape — does NOT warrant new variant
