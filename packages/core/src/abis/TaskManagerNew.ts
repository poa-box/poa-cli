...
export const TaskManagerNewAbi = [
  {
    "type": "constructor",
    "inputs": [],
    ...
    "inputs": [
      {
        "name": "projects",
        "type": "tuple[]",
        "internalType": "struct TaskManager.BootstrapProjectConfig[]",
        "components": [
          {
            "name": "title",
            "type": "bytes",
      ...
      },
      {
        "name": "tasks",
        "type": "tuple[]",
        "internalType": "struct TaskManager.BootstrapTaskConfig[]",
        "components": [
          {
            "name": "projectIndex",
            "type": "uint8",
    ...
    "inputs": [
      {
        "name": "key",
        "type": "uint8",
        "internalType": "enum TaskManager.ConfigKey"
      },
      {
        "name": "value",
        "type": "bytes",
    ...
    "inputs": [
      {
        ...
        "type": "uint8",
        "indexed": false,
        "internalType": "enum TaskManager.HatType"
      },
      {
        "name": "hat",
        "type": "uint256",
...
export default TaskManagerNewAbi;
