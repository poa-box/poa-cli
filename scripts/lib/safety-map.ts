...
export const WRITE_COMMANDS: Record<string, CommandSafety> = {
  'role set-perm': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role clear-perm': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role create': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role claim': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role renounce': { broadcasts: true, destructive: true, file: 'src/commands/role/authority.ts' },
  'role grant': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role offer': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role remove': { broadcasts: true, destructive: true, file: 'src/commands/role/authority.ts' },
  'role unremove': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role withdraw-offer': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role clear-rule': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role set-rule': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role set-default': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role rename': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role set-max-members': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role set-manager': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role delegate-grant': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role delegate-offer': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role delegate-unremove': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role delegate-remove': { broadcasts: true, destructive: true, file: 'src/commands/role/authority.ts' },
  'role finalize': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role cancel': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role reconcile': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'role set-paused': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'group create': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'group add-role': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'group remove-role': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'vouch for': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'vouch revoke': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'vouch claim': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'vouch configure': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'vouch reset': { broadcasts: true, destructive: true, file: 'src/commands/role/authority.ts' },
  'vouch clear-user': { broadcasts: true, destructive: true, file: 'src/commands/role/authority.ts' },
  'vouch set-rate-limit': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  // ── task ──
  ...
  'task perms clear': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'task perms set': { broadcasts: true, file: 'src/commands/role/authority.ts' },
  'task perms propose-global': { broadcasts: true, file: 'src/commands/role/authority.ts' },
