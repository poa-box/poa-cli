...
| [guides/integrators.md](guides/integrators.md) | **Integrating POP into your app** — chooser + quickstarts for all three surfaces: `@poa/core` (frontends/JS), CLI `--json` (any language), MCP (AI agents) |
