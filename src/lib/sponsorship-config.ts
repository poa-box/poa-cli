/**
 * Sponsorship config resolution — CLI wrapper over @poa/core.
 *
...
import { resolveSponsoredConfig as coreResolveSponsoredConfig } from '@poa/core/sponsorship-config';
import type { SponsoredConfig } from '@poa/core/sponsorship-config';

export type { SponsoredConfig };

/**
 * Resolve sponsored config from environment variables. Returns undefined when
 * any required piece is missing. See @poa/core/sponsorship-config for the
